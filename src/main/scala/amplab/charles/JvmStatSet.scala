...
class JvmStatSet(val isMinimal: Boolean = false) extends MetricSet {
	...
	"sun.gc.collector.1.oldMarkedForYoung" -> "oldMarkedForYoung1",
	"sun.gc.collector.1.oldScannedForYoung" -> "oldScannedForYoung1",
	"sun.gc.collector.1.inOldScannedForYoung" -> "inOldScannedForYoung1",
	"sun.gc.collector.1.inOldBytesScannedForYoung" -> "inOldBytesScannedForYoung1",
	"sun.gc.collector.1.inOldCardsScannedForYoung" -> "inOldCardsScannedForYoung1",
	"sun.gc.collector.1.inOldCardsFoundForYoung" -> "inOldCardsFoundForYoung1",
	"sun.gc.collector.1.oldToYoungPointers" -> "oldToYoungPointers1",
        "sun.gc.collector.1.goodInOldScannedForYoung" -> "goodInOldScannedForYoung1",
        "sun.gc.collector.1.bogusCards" -> "bogusCards1",
        "sun.gc.collector.1.oneObjectCardRanges" -> "oneObjectCardRanges1",

	"sun.gc.collector.2.scanned" -> "oldScanned2",
	"sun.gc.collector.2.marked" -> "oldMarked2",
	"sun.gc.collector.2.bytesPretenured" -> "bytesPretenured2",
	"sun.gc.collector.2.oldMarkedForYoung" -> "oldMarkedForYoung2",
	"sun.gc.collector.2.oldScannedForYoung" -> "oldScannedForYoung2",
	"sun.gc.collector.2.inOldScannedForYoung" -> "inOldScannedForYoung2",
	"sun.gc.collector.2.inOldBytesScannedForYoung" -> "inOldBytesScannedForYoung2",
	"sun.gc.collector.2.inOldCardsScannedForYoung" -> "inOldCardsScannedForYoung2",
	"sun.gc.collector.2.inOldCardsFoundForYoung" -> "inOldCardsFoundForYoung2",
	"sun.gc.collector.2.oldToYoungPointers" -> "oldToYoungPointers2",
        "sun.gc.collector.2.goodInOldScannedForYoung" -> "goodInOldScannedForYoung2",
        "sun.gc.collector.2.bogusCards" -> "bogusCards2",
        "sun.gc.collector.2.oneObjectCardRanges" -> "oneObjectCardRanges2",
